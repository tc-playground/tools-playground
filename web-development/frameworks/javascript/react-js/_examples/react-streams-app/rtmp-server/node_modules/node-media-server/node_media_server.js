...
const Https = require('node-media-server/node_modules/https');
const NodeRtmpServer = require('node-media-server/node_rtmp_server');
const NodeHttpServer = require('node-media-server/node_http_server');
...
const NodeIpcServer = require('node-media-server/node_ipc_server');
const context = require('node-media-server/node_core_ctx');
const Package = require("node-media-server/package.json");
