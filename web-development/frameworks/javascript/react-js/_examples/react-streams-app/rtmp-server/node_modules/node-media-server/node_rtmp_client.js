...
const EventEmitter = require('node-media-server/node_modules/events');
const Logger = require('node-media-server/node_core_logger');
const Crypto = require('node-media-server/node_modules/crypto');
const Url = require('node-media-server/node_modules/url');
const Net = require('node-media-server/node_modules/net');
